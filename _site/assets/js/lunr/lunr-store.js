var store = [{
        ...
        "excerpt":"This tutorial demonstrates how to build, train, and deploy a machine learning model using Amazon SageMaker. It covers classifying images using Transfer Learning, a technique that leverages a pre-trained model to solve a new problem with less data and computing time. This workflow illustrates how cloud infrastructure democratizes access to...","categories": [],
        "tags": [],
        "url": "/anusha-jeyaseelan/amazon-sagemaker/overview/",
        "teaser": null
      },{
        "title": "AWS Technical Writing Portfolio",
        "excerpt":"This portfolio showcases my work as a Senior Technical Writer at Amazon Web Services, where I developed end-to-end developer documentation for AWS security analytics and threat investigation services. I specialized in API documentation, data lake ingestion workflows, and scalable content systems that support security engineers, cloud architects, and enterprise customers....","categories": [],
        "tags": [],
        "url": "/anusha-jeyaseelan/anusha-portfolio/aws",
        "teaser": null
      },{
        "title": "Cisco Technical Writing Portfolio",
        "excerpt":"This portfolio showcases my work as a Lead Technical Writer at Cisco, where I developed end-to-end technical content for enterprise networking, Kubernetes platforms, hyperconverged infrastructure (HCI), and cloud-managed infrastructure. I specialized in API documentation, configuration workflows, and scalable documentation systems that support engineering and customer success teams. Key Contributions: Created...","categories": [],
        "tags": [],
        "url": "/anusha-jeyaseelan/anusha-portfolio/cisco",
        "teaser": null
      },{
        "title": "Walmart Global Tech Portfolio",
        "excerpt":"This portfolio showcases my work as a Staff Content Strategist at Walmart Global Tech, where I led the transformation of Marketplace API documentation. My core focus areas are API reference design, developer guides, building scalable documentation systems, integrating Git-based workflows, and AI-assisted authoring to enable engineering teams and global developers...","categories": [],
        "tags": [],
        ...
        "excerpt":"To demonstrate the “Documentation as a Platform” philosophy, I architected this portal using a modern, docs-as-code stack. This site isn’t just a portfolio; it is a functional proof-of-concept for how NVIDIA can scale documentation across millions of users and thousands of products. Key Engineering Features: Automated API Orchestration: Using Fern...","categories": [],
        "tags": [],
